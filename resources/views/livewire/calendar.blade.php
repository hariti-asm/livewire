<div class="flex flex-col justify-center items-center text-[#272a2f]">
    <div class="w-full max-w-[400px] rounded-md shadow-sm translate-y-1 translate-x-[-0.0625rem] border border-black">
        <div class="  bg-gray-100">
            ...
            <p class="text-md">Book for free</p></div>
        </div>
    ...
    <div class="grid grid-cols-7 text-center  px-4 mt-4 mb-6">
    ...
    <div class="grid grid-cols-7 gap-1  px-4 ">
      @foreach ($days as $day)
        @if(!empty($day))
          <div class="aspect-square  flex items-center justify-center border border-1 h-10 w-12 rounded-sm  px-1 hover:border-[#00665C] hover:text-[#00665C]">
            {{ $day }}
          </div>
        @else
    ...
    <p class="whitespace-nowrap  mx-4 text-sm tracking-normal	">
        ...
        <span class=" whitespace-nowrap text-sm mx-4 tracking-normal	">
            may vary as you continue the booking process.
